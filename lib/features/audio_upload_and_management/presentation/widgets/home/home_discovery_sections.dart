...
class HomeDiscoverySections extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SliverList.list(
      children: const [
        _SectionTitle(title: 'Today\'s pick', topPadding: 28, eyebrow: 'HOT FOR YOU'),
        _FeaturedPickCard(),
...
class _SectionTitle extends StatelessWidget {
  const _SectionTitle({required this.title, required this.topPadding, this.eyebrow});
          ...
          child: Row(
            children: [
              ...
              CircleAvatar(
                ...
                child: Icon(Icons.play_arrow_rounded, color: Colors.black, size: 38),
              ),
            ],
          ),
        ),
