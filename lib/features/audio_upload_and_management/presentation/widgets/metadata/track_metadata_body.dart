          ...
          _MetadataCard(
            child: switch (selectedTab) {
              ...
              UploadMetadataTab.permissions => PermissionsMetadataSection(
                ...
                onOfflineListeningChanged: metadataNotifier.setOfflineListening,
                onIncludeInRssChanged: metadataNotifier.setIncludeInRss,
                onDisplayEmbedCodeChanged: metadataNotifier.setDisplayEmbedCode,
                onAppPlaybackEnabledChanged:
                    metadataNotifier.setAppPlaybackEnabled,
                onAvailabilityTypeChanged: metadataNotifier.setAvailabilityType,
