...
extension _PlayerNotifierSources on PlayerNotifier {
  ...
  Future<_ResolvedPlaybackSource> _resolvePlaybackSource(
    ...
    // Request a signed streaming URL from the server. Private tracks must
    // carry privateToken or the backend responds 403 `private_no_token`.
    final streamUrl = await _requestStream(
      trackId,
